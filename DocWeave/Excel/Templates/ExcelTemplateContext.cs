...
/// </summary>
internal sealed partial class ExcelTemplateContext
{
    ...
    [GeneratedRegex("\\{\\{\\s*parameters\\.(?<name>[A-Za-z_][A-Za-z0-9_]*)\\s*\\}\\}", RegexOptions.IgnoreCase)]
    private static partial Regex ParameterExpressionRegex();
}
