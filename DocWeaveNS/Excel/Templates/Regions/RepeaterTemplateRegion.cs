...
/// </summary>
internal sealed class RepeaterTemplateRegion : ExcelTemplateRegionCompiler
{
    private static readonly Regex ValueExpression = new("VALUE\\((?<field>[A-Za-z_][A-Za-z0-9_]*)\\)", RegexOptions.IgnoreCase | RegexOptions.Compiled);
    ...
    private static Regex ValueExpressionRegex()
    {
