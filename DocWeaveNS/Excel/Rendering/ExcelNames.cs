...
internal static class ExcelNames
{
    internal static string SanitizeSheetName(string value)
    {
        ...
        return string.IsNullOrWhiteSpace(safe) ? "Sheet" : safe.Substring(0, Math.Min(31, safe.Length));
    }
    ...
    internal static string SanitizePivotName(string value)
    {
        ...
        return string.IsNullOrWhiteSpace(safe) ? "PivotTable" : safe.Substring(0, Math.Min(255, safe.Length));
    }
